...
function [Sdis, C, CNodes, b_dis] = CreateDiscon3D_NoEmptyEl_V2_Multigrid(numElements, Elements, numNodes, Nodes, numBC, BC)
...
%             tempElements(localBCnodes,:) = -1*ones(length(localBCnodes),1); %[];% Added on 4-2-2010
